...
архитектуре e2k от компании МЦСТ со следующими характеристиками:
...
компилятор LCC-1.29.12 от МЦСТ, который является совместимым с
gcc 11.3.0:
...
и запущенный нативно нашей компанией НИЦ ЦТ под архитектуру e2k:
...
другая популярная библиотека cppcoro не имеет поддержки e2k.
...
**wrk**, корректно работающий с асинхронными и серверами, основанными на
корутинах, так как при использовании ApacheBench сервер с keep-alive
...
запросов в секунду при средней задержке 364 мкс или 0.36413 мс, что дает
